          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item">
                ...
                <a href="<%= Page.ResolveUrl("http://localhost:30200/login.aspx") %>" class="nav-link active" target="_blank" aria-current="page" >LOGIN</a>  
              </li>
              <li class="nav-item">
               
                  <a href="<%= Page.ResolveUrl("http://localhost:30200/Register.aspx") %>" class="nav-link active" target="_blank" aria-current="page" >CREATE ACCOUNT</a>
              </li>
